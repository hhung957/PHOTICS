...
<body>
    ...
    <div class='wrapper'>
        <sql:setDataSource var = "database" driver="com.mysql.jdbc.Driver" url="jdbc:mysql://localhost:3306/photics" 
                           user="root" password=""/>
        <sql:query dataSource="${database}" sql="SELECT * from image WHERE caption LIKE '%${sessionScope.key}%' AND category LIKE '%${sessionScope.category}%' ORDER BY RAND()" var="result"/>
